...
class LatentDiffusion(pl.LightningModule):
    def __init__(self,
        ...
        # ans: like a param but cannot be updated by optimizer
        ...
        # ans: freeze vae's params then optimizer cannot update it(don't fit its params)
        ...
        # TODO begin: Complete the DenoisingDiffusionProcess    
    ...
    def forward(self,*args,**kwargs):
        ...
        # ans: params of model, when input's type is tuple, take every element as param;
        #                       when input's type is dict, take every key-value pair as param's name-value
